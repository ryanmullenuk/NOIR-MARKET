...
/* Stop historical release bootstraps from all starting together. Their gameplay
   functions remain available, but V9.4 owns the single active startup path. */
(function(){
...
function particles() {
    // V9.4 deliberately uses static visuals. Keep the compatibility hook cheap.
    return;
}
...
/* The previous assignment resolved back to this same hoisted function and caused
   an infinite render recursion. V9.4 starts this renderer as the clean base. */
...
/* Restore normal browser scheduling for the single V9.4 startup controller. */
...
(function(){
  ...
  function initRendererV93(){
    lockMetadata();
    try{loadGameV93();}catch(e){console.error('V9.4 load failed:',e);}
    var preintro=document.getElementById('preintro');
