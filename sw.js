const CACHE_NAME='noir-market-v6.5';
...
const OPTIONAL_ASSETS=['./assets/music/noir_market_music.mp3','./assets/uk-start-map.png','./icon-192.png','./icon-512.png','./apple-touch-icon.png','./apple-touch-icon-dark.png','./apple-touch-icon-light.png','./icon-192-light.png','./icon-512-light.png'];
