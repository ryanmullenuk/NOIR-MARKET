const CACHE_NAME='noir-market-v9.7.0';
const CORE_ASSETS=['./','./index.html','./styles.css?v=9.7.0','./game.js?v=9.7.0','./manifest.json?v=9.7.0','./assets/redhead-games-logo.png'];
