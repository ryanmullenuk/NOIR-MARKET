...
Noir Market is a static, installable browser game hosted at [redhead.games](https://redhead.games/index.html). The current release is V9.4.
...
- `game.js` contains game state, features, save migrations and the single active V9.4 renderer.
...
- Browser saves use `localStorage`. V9.4 writes `noir_market_v9_4` and migrates earlier supported keys.
