...
/* Noir Market V1.6 final override layer */
/* Noir Market V1.6 economy, reputation, rank, hustle and vault upgrades */
...
function v13SelfTest(){console.log('NOIR MARKET V1.6 checks: dynamic city economy, market rumours, news ticker, reputation, arrest/bribe system, informants, city vault upgrades and rank progression active.');}



/* Noir Market V1.6 final audio loop override */
function startBackgroundMusic(){
  if(!soundEnabled)return;
  unlockAudio();
  musicStarted=true;
...
/* Noir Market V1.6 immediate rank drop enforcement */
function rank(){
  ensureRankState();
...
/* Noir Market V1.6 news, notifications, hustle and storage overrides */
...
function v16IconSelfTest(){console.log('NOIR MARKET V1.6 checks: uppercase smooth ticker, police/spiked batch stories, top-layer notifications, revised hustle informants, coming soon businesses, storage spacing and new MP3 music active.');}

/* Noir Market V1.6 proportional loan interest override */
...
function v16SelfTest(){console.log('NOIR MARKET V1.6 checks: proportional loan interest, early settlement discount, full-term interest, missed-payment penalty and V1.4 save migration active.');}
